...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNSAPPEDBYDREAMDRAIN]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s health is sapped by Dream Drain!"),
    ...
    [STRINGID_PKMNBLEWAWAYSPIKES]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} removed the Spikes!"), //not in gen 5+, generic rapid spin?
    ...
    [STRINGID_PKMNHURTSWITH]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} was hurt by {B_DEF_NAME_WITH_PREFIX2}'s {B_BUFF1} Ability!"),
    ...
    [STRINGID_PKMNSXINFATUATEDYPURELOVE]            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY} infatuated {B_DEF_NAME_WITH_PREFIX2}!"),
    ...
    [STRINGID_SUNSALUTEENTERNS]                     = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} salutes the sun!"),
    ...
    [STRINGID_PKMNBLEWAWAYTOXICSPIKES]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} removed the Toxic Spikes!"),
    [STRINGID_PKMNBLEWAWAYSTICKYWEB]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} removed the Sticky Web!"),
    [STRINGID_PKMNBLEWAWAYSTEALTHROCK]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} removed the Stealth Rock!"),
    ...
    [STRINGID_INTENSEHAILSTORM]                     = COMPOUND_STRING("An intense hailstorm is protecting Ice-type Pokémon!"),
    [STRINGID_HAILSTORMSTOPPED]                     = COMPOUND_STRING("The intense hailstorm has come to an end!"),
    [STRINGID_HAILWONTSTOP]                         = COMPOUND_STRING("The intense hailstorm won't stop crashing down!"),
    [STRINGID_ATTACKWEAKENEDBHAILSTORM]             = COMPOUND_STRING("The attack was weakened by the intense hailstorm!"),
    ...
    [STRINGID_PKMNBLEWAWAYSHARPSTEEL]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} removed the sharp steel!"),
    ...
    [STRINGID_ALLURINGODORWAFTS]                    = COMPOUND_STRING("An alluring odor is wafting from {B_ATK_NAME_WITH_PREFIX2}!"),
    ...
    [STRINGID_SELFSTATLOWERBLOCKED]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ABILITY} prevents stat loss!")
};
...
const u16 gSwitchInAbilityStringIds[] =
{
    ...
    [B_MSG_SWITCHIN_SUN_SALUTE] = STRINGID_SUNSALUTEENTERNS,
};
