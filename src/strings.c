...
const u8 gText_CleanseTagTurnOn[] = _("Enabled the Cleanse Tag.\nAll wild encounters will be avoided.{PAUSE_UNTIL_PRESS}");
const u8 gText_CleanseTagTurnOff[] = _("Disabled the Cleanse Tag.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ReachedLevelCap[] = _("The level cap has been reached.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_EVIVControlInfo[] = _("{FONT_NARROW}{L_BUTTON}EV {R_BUTTON}IV {START_BUTTON}Stat");
const u8 gText_EditEVs[] = _("Edit EVs");
...
const u8 gText_XNatureMetAtYZ[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature, met at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
const u8 gText_XNatureHatchedAtYZ[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature, hatched {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
const u8 gText_XNatureObtainedInTrade[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nobtained in a trade.");
const u8 gText_XNatureFatefulEncounter[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nfatefully met at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
...
const u8 gText_BattleItems[] = _("BattleItems");
...
const u8 gText_BagInBattle[] = _("Bag in Battle");
...
const u8 gText_BattleSceneBosses[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Bosses");
...
const u8 gText_BagInBattleEnabled[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Enabled");
const u8 gText_BagInBattleDisabled[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Disabled");
...
const u8 gText_LevelCapsNone[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}None");
const u8 gText_LevelCapsNormal[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Normal");
const u8 gText_LevelCapsHard[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Hard");
const u8 gText_EXPShareEnabled[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}On");
const u8 gText_EXPShareDisabled[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Off");
...
const u8 gText_MoveRelearnerAndPoof[] = _("{PAUSE 32}1, {PAUSE 15}2, and {PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}Poof!\p"); // unused to speed up move relearn
const u8 gText_MoveRelearnerPkmnForgotMoveAndLearnedNew[] = _("{STR_VAR_1} learned {STR_VAR_2}!");
...
// pokevial branch
const u8 gText_PokevialHasDoses[] =_("Use the Pokévial?");
const u8 gText_YourPkmnWereRestored[] =_("Your Pokémon were restored to full health.{PAUSE_UNTIL_PRESS}");

//HGSS_Ui PokedexPlus
const u8 gText_Stats_Buttons[]  = _("{A_BUTTON}TOGGLE   {DPAD_UPDOWN}MOVES   {START_BUTTON}TOGGLE ABILITY 1/2");
const u8 gText_Stats_Buttons_Decapped[]  = _("{A_BUTTON}Toggle   {DPAD_UPDOWN}Moves   {START_BUTTON}Toggle Ability 1/2");
...
const u8 gText_EVO_FRIENDSHIP_MOVE_TYPE[]           = _("Friendly, knows {STR_VAR_2} move");
