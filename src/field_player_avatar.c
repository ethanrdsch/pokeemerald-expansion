...
//static bool8 IsSidewaysStairToRight(s16, s16, u8); <- unused apparently
//static bool8 IsSidewaysStairToLeft(s16, s16, u8); <- unused apparently
...
u8 CheckForObjectEventCollision(struct ObjectEvent *objectEvent, s16 x, s16 y, u8 direction, u8 metatileBehavior)
{
    ...
    //u8 currentBehavior = MapGridGetMetatileBehaviorAt(objectEvent->currentCoords.x, objectEvent->currentCoords.y); <- unused
