...
u32 TrySetCantSelectMoveBattleScript(u32 battler)
{
    ...
    if (DYNAMAX_BYPASS_CHECK 
        && (GetBattlerAbility(battler) == ABILITY_GORILLA_TACTICS
            || GetBattlerAbility(battler) == ABILITY_SAGE_POWER) 
...
u8 AtkCanceller_UnableToUseMove(u32 moveType)
{
    ...
    do
    {
        ...
        case CANCELLER_ASLEEP: // check being asleep
            if (gBattleMons[gBattlerAttacker].status1 & STATUS1_SLEEP && !(gMovesInfo[gCurrentMove].wakesUser))
            {
        ...
        case CANCELLER_POWDER_MOVE:
            if ((gMovesInfo[gCurrentMove].powderMove) 
...
bool32 CanBePoisoned(u32 battlerAtk, u32 battlerDef, u32 defAbility)
{
    if (!(CanPoisonType(battlerAtk, battlerDef))
     ...
     || defAbility == ABILITY_WONDER_SKIN
     || defAbility == ABILITY_PURE_CRYSTAL
     || defAbility == ABILITY_FLOWER_VEIL
        ...
        case HOLD_EFFECT_FLINCH:
            {
                ...
                if (ability == ABILITY_SERENE_GRACE
                    || (ability == ABILITY_STARRY_FIST && gMovesInfo[gCurrentMove].punchingMove))
...
static uq4_12_t GetWeatherDamageModifier(u32 battlerAtk, u32 move, u32 moveType, u32 holdEffectAtk, u32 holdEffectDef, u32 weather)
{
    if (weather == B_WEATHER_NONE)
        return UQ_4_12(1.0);
    if (gMovesInfo[move].effect == EFFECT_HYDRO_STEAM 
...
static inline uq4_12_t CalcTypeEffectivenessMultiplierInternal(u32 move, u32 moveType, u32 battlerAtk, u32 battlerDef, bool32 recordAbilities, uq4_12_t modifier, u32 defAbility)
{
    ...
    if (gMovesInfo[move].category == DAMAGE_CATEGORY_STATUS && move != MOVE_THUNDER_WAVE && move != MOVE_WILL_O_WISP)
    {
        modifier = UQ_4_12(1.0);
...
u32 CalcSecondaryEffectChance(u32 battler, u32 battlerAbility, const struct AdditionalEffect *additionalEffect)
{
    bool8 hasSereneGrace = (battlerAbility == ABILITY_SERENE_GRACE 
                            || (battlerAbility == ABILITY_STARRY_FIST && gMovesInfo[gCurrentMove].punchingMove));
