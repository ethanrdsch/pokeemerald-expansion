...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_CHIMCHAR] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_IRON_FIST, ABILITY_VERSATILE },
    ...
    [SPECIES_BIDOOF] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_SIMPLE, ABILITY_LOYAL_COMPANION, ABILITY_UNAWARE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SHIELDON] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_IMPENETRABLE, ABILITY_SOLID_ROCK, ABILITY_DAUNTLESS_SHIELD },
...
#define MOTHIM_SPECIES_INFO                                                          \
    ...
    [SPECIES_BUIZEL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_PROPELLER_TAIL, ABILITY_LOYAL_COMPANION, ABILITY_SWIFT_SWIM },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CHERUBI] =
    {
        ...
        .abilities = { ABILITY_SELF_SUFFICIENT, ABILITY_NONE, ABILITY_NONE },
    ...
    [SPECIES_LOPUNNY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_STRIKER, ABILITY_KLUTZ, ABILITY_LIMBER },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LIGHTS_BANE, ABILITY_NONE, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_RIOLU] =
    {
        ...
        .abilities = { ABILITY_AURA_BOOST, ABILITY_INNER_FOCUS, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Riolu"),
        .cryId = CRY_RIOLU,
    ...
    [SPECIES_LUCARIO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_AURA_BOOST, ABILITY_INNER_FOCUS, ABILITY_VERSATILE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_HIPPOPOTAS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAND_STREAM, ABILITY_STALWART, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CARNIVINE] =
    {
        ...
        .abilities = { ABILITY_BINDING_GRIP, ABILITY_STRONG_JAW, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_ABOMASNOW_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_HAILSTORM, ABILITY_HAILSTORM, ABILITY_HAILSTORM },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Abomasnow"),
    ...
    [SPECIES_DIALGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_FOREWARN, ABILITY_TELEPATHY },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_PALKIA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_WATER_VEIL, ABILITY_TELEPATHY },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GIRATINA_ALTERED] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_SHADOW_SHIELD, ABILITY_TELEPATHY },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_PHIONE] =
    {
        ...
        .abilities = { ABILITY_SOUL_HEART, ABILITY_NONE, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MANAPHY] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_HYDRATION, ABILITY_NONE, ABILITY_SOUL_HEART },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DARKRAI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BAD_DREAMS, ABILITY_NONE, ABILITY_LIGHTS_BANE },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_SHAYMIN_LAND] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FLOWER_VEIL, ABILITY_SELF_SUFFICIENT, ABILITY_GRASSY_SURGE},
        .bodyColor = BODY_COLOR_GREEN,
