...
static const struct FormChange sDarmanitanFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_DARMANITAN_STANDARD, ABILITY_ZEN_MODE, HP_HIGHER_THAN,   100},
...
static const struct FormChange sDarmanitanGalarFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_DARMANITAN_GALAR_STANDARD, ABILITY_ZEN_MODE, HP_HIGHER_THAN,   100},
...
static const struct FormChange sFurfrouFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_FURFROU_NATURAL,   ITEM_STYLE_KIT, 0},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_FURFROU_HEART,     ITEM_STYLE_KIT, 1},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_FURFROU_STAR,      ITEM_STYLE_KIT, 2},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_FURFROU_DIAMOND,   ITEM_STYLE_KIT, 3},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_FURFROU_DEBUTANTE, ITEM_STYLE_KIT, 4},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_FURFROU_MATRON,    ITEM_STYLE_KIT, 5},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_FURFROU_DANDY,     ITEM_STYLE_KIT, 6},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_FURFROU_LA_REINE,  ITEM_STYLE_KIT, 7},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_FURFROU_KABUKI,    ITEM_STYLE_KIT, 8},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_FURFROU_PHARAOH,   ITEM_STYLE_KIT, 9},
    {FORM_CHANGE_TERMINATOR},
};
