...
static bool32 FindMonThatAbsorbsOpponentsMove(u32 battler)
{
    ...
    if (incomingType == TYPE_FIRE)
    {
        ...
        absorbingTypeAbilities[numAbsorbingAbilities++] = ABILITY_SUN_SALUTE;
    }
    ...
    else if (incomingType == TYPE_GHOST || (isOpposingBattlerChargingOrInvulnerable && incomingType == TYPE_GHOST))
    {
        absorbingTypeAbilities[numAbsorbingAbilities++] = ABILITY_SOUL_ABSORB;
    }
    else if (incomingType == TYPE_GROUND || (isOpposingBattlerChargingOrInvulnerable && incomingType == TYPE_GROUND))
    {
        ...
        absorbingTypeAbilities[numAbsorbingAbilities++] = ABILITY_AERIAL_SCOUT;
        absorbingTypeAbilities[numAbsorbingAbilities++] = ABILITY_INSECTOID;
    }
...
bool32 IsMonGrounded(u16 heldItemEffect, u32 ability, u8 type1, u8 type2)
{
    ...
    if (type1 == TYPE_FLYING || type2 == TYPE_FLYING || ability == ABILITY_LEVITATE || ability == ABILITY_AERIAL_SCOUT || ability == ABILITY_INSECTOID
