...
extern const u8 gText_BagInBattleEnabled[];
extern const u8 gText_BagInBattleDisabled[];
...
extern const u8 gText_ReachedLevelCap[];
...
extern const u8 gText_EVIVControlInfo[];
extern const u8 gText_EditEVs[];
