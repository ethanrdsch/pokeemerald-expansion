...
enum StringID
{
    ...
    STRINGID_PKMNSAPPEDBYDREAMDRAIN,
    ...
    STRINGID_PKMNSXINFATUATEDYPURELOVE,
    ...
    STRINGID_INTENSEHAILSTORM,
    STRINGID_HAILSTORMSTOPPED,
    STRINGID_HAILWONTSTOP,
    STRINGID_ATTACKWEAKENEDBHAILSTORM,
