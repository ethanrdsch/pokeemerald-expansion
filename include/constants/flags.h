...
#define FLAG_GEN6_EXP_SHARE  0x20 // Toggles EXP all
...
#define FLAG_ITEM_WILDFLOWERFIELDS_TM_THIEF                         0x465
...
#define FLAG_PAUSE_TIME                                             0x493 // Pauses time
#define FLAG_NO_ENCOUNTER                                           0x494 // Turns off wild encounters
#define FLAG_NO_TRAINER_SEE                                         0x495 // Turns off trainers' vision
#define FLAG_POKE_RIDER                                             0x496 // Pokerider toggle
