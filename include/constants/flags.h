...
#define FLAG_TEMP_BATTLE     0x23 // Unused Flag
...
#define FLAG_CLEANSE_TAG                     0xE9 // Is the Cleanse Tag Active? (i.e. should wild encounters be enabled?)
...
#define FLAG_DISABLE_MON_EDITING             0x1AA // Should move relearning, EV editing, and PC access from start menu be allowed?
...
#define FLAG_UNUSED_0x493                                           0x493 // Bag use in battle
...
#define FLAG_EXP_ALL                                (SYSTEM_FLAGS + 0x21) // whether the EXP share is toggled in the options menu
