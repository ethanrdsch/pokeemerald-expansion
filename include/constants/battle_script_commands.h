...
#define VARIOUS_TRY_ACTIVATE_NO_RECHARGE             145
#define VARIOUS_TRY_ABILITY_REMOVE_HAZARDS           146
...
#define DMG_1_6_TARGET_HP          4
#define DMG_FULL_ATTACKER_HP       5
#define DMG_CURR_ATTACKER_HP       6
#define DMG_BIG_ROOT               7
#define DMG_1_2_ATTACKER_HP        8
#define DMG_RECOIL_FROM_IMMUNE     9 // Used to calculate recoil for the Gen 4 version of Jump Kick
