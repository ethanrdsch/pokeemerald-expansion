...
extern const u8 BattleScript_DreamDrainTurnDrainLiquidOoze[];
extern const u8 BattleScript_LeechSeedTurnDrainHealBlock[];
extern const u8 BattleScript_DreamDrainTurnDrainHealBlock[];
extern const u8 BattleScript_LeechSeedTurnDrainRecovery[];
extern const u8 BattleScript_DreamDrainTurnDrainRecovery[];
...
extern const u8 BattleScript_RockSmashStealthRock[];
extern const u8 BattleScript_WrapFree[];
extern const u8 BattleScript_LeechSeedFree[];
extern const u8 BattleScript_SpikesFree[];
extern const u8 BattleScript_SpikesFreeWithPopup[];
...
extern const u8 BattleScript_AbilityNoSelfStatLoss[];
...
extern const u8 BattleScript_PureLoveActivates[];
extern const u8 BattleScript_AbilityStatusEffect[];
extern const u8 BattleScript_AbilityLeechSeed[];
extern const u8 BattleScript_SoundTherapy[];
extern const u8 BattleScript_TwoStep[];
...
extern const u8 BattleScript_TruantLoafingAroundLazyMove[];
...
extern const u8 BattleScript_ToxicSpikesFreeWithPopup[];
extern const u8 BattleScript_StickyWebFree[];
extern const u8 BattleScript_StickyWebFreeWithPopup[];
extern const u8 BattleScript_StealthRockFree[];
extern const u8 BattleScript_StealthRockFreeWithPopup[];
...
extern const u8 BattleScript_HailstormActivates[];
extern const u8 BattleScript_HailWontStop[];
extern const u8 BattleScript_AttackWeakenedByHailstorm[];
...
extern const u8 BattleScript_SteelsurgeFreeWithPopup[];
...
extern const u8 BattleScript_EffectEvasionDown3[];
...
extern const u8 BattleScript_EffectSpiderWeb[];
...
extern const u8 BattleScript_EffectMilkDrink[];
...
extern const u8 BattleScript_EffectTailwindAbility[];
extern const u8 BattleScript_EffectTailwindAbilityNoLoop[]; 
...
extern const u8 BattleScript_EffectPowderAbility[];
